...
INTERFACE
    VAR
        ...
        HMI : OperatorCmds_typ; (*Operator interaction commands*)
        vMotorRotating : REAL; (*HMI Support variables*)
    END_VAR
END_INTERFACE
PROGRAM main:
...
(*HMI *)
vMotorRotating := vMotorRotating + 2 * BOOL_TO_REAL(IO.xDI_M1_MixerMotorRunning);
